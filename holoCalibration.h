...
class HoloCalibration
{
    ...
    private:
        ...
        static constexpr int VENDOR_ID_FIRSTGEN {0x04d8};
        static constexpr int VENDOR_ID_PORTRAIT {0x05df};
        static constexpr int INTERFACE_NUM_FIRSTGEN {2};
        enum DeviceType{NONE, FIRSTGEN, PORTRAIT};
};
